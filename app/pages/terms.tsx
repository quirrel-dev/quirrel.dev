  ...
  return (
    <main className="prose mx-auto">
      ...
      <p>
        ...
        personally or on behalf of an entity (“you”) and Simon Knott ("Company", “we”, “us”, or
        “our”), concerning your access to and use of the https://quirrel.dev website as well as any
        ...
        Site, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU
      ...
      <h2>CANCELLATION</h2>
      <p>
        You can cancel your subscription at any time by logging into your account or contacting us
        using the contact information provided below. Your cancellation will take effect at the end
        of the current paid term.
      </p>
      <p>
        If you are unsatisfied with our services, please email us at legal@quirrel.dev or call us at
        +49 1573 8104606.
      </p>
      ...
      <ol>
        ...
        <li>
          ...
          or these Terms of Use, including without limitation, reporting such user to law
          enforcement authorities; (3) in our sole discretion and without limitation, refuse,
      ...
      <p>
        ...
        https://quirrel.dev/privacy. By using the Site, you agree to be bound by our Privacy Policy,
      ...
      <h2>GOVERNING LAW</h2>
      <p>
        These conditions are governed by and interpreted following the laws of Germany, and the use
        ...
        your country of residence. Simon Knott and yourself both agree to submit to the
        non-exclusive jurisdiction of the courts of Berlin, which means that you may make a claim to
        defend your consumer protection rights in regards to these Conditions of Use in Germany, or
      ...
      <p>
        ...
        acceptance. The seat of arbitration shall be Berlin, Germany. The language of the
      ...
      <p>
        ...
        and expenses, made by any third party due to or arising out of: (1) use of the Site; (2)
        ...
        other user of the Site with whom you connected via the Site. Notwithstanding the foregoing,
