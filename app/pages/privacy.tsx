...
const Privacy: BlitzPage = () => {
  return (
    <main className="prose mx-auto">
      ...
      <p>
        Thank you for choosing to be part of our community at Quirrel ("company", "we", "us",
        "our"). We are committed to protecting your personal information and your right to privacy.
        If you have any questions or concerns about our policy, or our practices with regards to
        your personal information, please contact us at legal@quirrel.dev.
      </p>

      <p>
        When you visit our website https://quirrel.dev, and use our services, you trust us with your
      ...
      <p>
        ...
        https://quirrel.dev), and/or any related services, sales, marketing or events (we refer to
      ...
      <p>
        ...
        when participating in activities on the Sites or otherwise contacting us.
      </p>
      ...
      <p>
        ...
        associated with your payment instrument. All payment data is stored by our payment processor
        and you should review its privacy policies and contact the payment processor directly to
      ...
      <ul>
        ...
        <li>
          ...
          partners may use the personal information you send to us for our marketing purposes, if
        ...
        <li>
          ...
          promotional campaigns and to evaluate and improve our Sites, products, services, marketing
          and your experience.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          or on our behalf and require access to such information to do that work. Examples include:
          ...
          Sites, which will enable them to collect data about how you interact with the Sites over
          time. This information may be used to, among other things, analyze and track data,
          determine the popularity of certain content and better understand online activity. Unless
          described in this Policy, we do not share, sell, rent or trade any of your information
      ...
      <p>
        Our servers are located in United States. If you are accessing our Sites from outside United
        States, please be aware that your information may be transferred to, stored, and processed
        by us in our facilities and by those third parties with whom we may share your personal
      ...
      <p>
        In particular Simon Knott complies with the EU-U.S. Privacy Shield Framework as set forth by
        the U.S. Department of Commerce regarding the collection, use, and retention of personal
        information transferred from the European Union to the United States and has certified its
        compliance with it. As such, Simon Knott is committed to subjecting all personal information
        received from European Union (EU) member countries, in reliance on the Privacy Shield
      ...
      <p>
        Simon Knott is responsible for the processing of personal information it receives, under the
        Privacy Shield Framework, and subsequently transfers to a third party acting as an agent on
        its behalf.
      </p>

      <p>
        With respect to personal information received or transferred pursuant to the Privacy Shield
        Framework, Simon Knott is subject to the regulatory enforcement powers of the U.S. FTC. In
        certain situations, we may be required to disclose personal information in response to
      ...
      <p>
        ...
        require us keeping your personal information for longer than 1 year past the termination of
        the user's account.
      </p>
      <p>
      ...
      <p>
        ...
        please contact us at legal@quirrel.dev.
      </p>
      ...
      <p>
        ...
        information from our active databases. However, some information my be retained in our files
      ...
      <p>
        ...
        and use of your account. To otherwise opt-out, you may: Contact us using the contact
      ...
      <p>
        If you have questions or comments about this policy, you may email us at legal@quirrel.dev
        or by post to:
      </p>
      <p>
        Simon Knott
